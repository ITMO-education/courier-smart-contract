...
import Counter from "../wrappers/SmartDelivery"; // this is the interface class from step 7
...
export async function run() {
    ...
    const mnemonic = "pluck present exhaust useful crater panda remove frog hen common purpose about capable bone across sign shop ride depart canyon wet thought surround later"
